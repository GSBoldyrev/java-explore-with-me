...
(
    id            BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    user_id       BIGINT,
    subscribed_on BIGINT,
    CONSTRAINT fk_subscribers_user_id FOREIGN KEY (user_id) REFERENCES users (id),
    CONSTRAINT fk_subscribers_subscribed_on FOREIGN KEY (subscribed_on) REFERENCES users (id)
)